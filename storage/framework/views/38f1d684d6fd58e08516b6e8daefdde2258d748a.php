...
<!-- Date Picker -->
<script src="<?php echo e(asset('kendoui.core/js/kendo.calendar.min.js')); ?>"></script>
<script src="<?php echo e(asset('kendoui.core/js/kendo.popup.min.js')); ?>"></script>
<script src="<?php echo e(asset('kendoui.core/js/kendo.datepicker.min.js')); ?>"></script>
...
$(function() {
	...
	$('#plotBtn').click(function() {
		...
		var dataSourceChart = new kendo.data.DataSource({
			transport: {
				read: {
					url: "<?php echo e(action('PriceTrendsController@index')); ?>",
					dataType: 'json',								
					data: data
				}
			}			
